...
public class FormicaTest {
	...
	@Test
	public void testIdProgressiviPerAggressive() {
		assertEquals("Gli id sono progressivi base 0 per ciascun tipo dinamico!", 0, new Aggressiva(this.ambiente).getId());
		assertEquals("Gli id sono progressivi base 0 per ciascun tipo dinamico!", 1, new Aggressiva(this.ambiente).getId());
	}
