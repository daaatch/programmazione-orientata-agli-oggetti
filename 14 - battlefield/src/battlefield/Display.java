...
public class Display extends JFrame {
	...
	private Color getColore(Battlefield field, Position posizione) {
		Robot t = field.getRobot(posizione);
		if(t==null) return Color.white;
		if(t.getClass() == Chaser.class) return Color.orange;
		if(t.getClass() == Walker.class) return Color.blue;			
		throw new IllegalStateException("Mi aspettavo di dover scegliere il colore di un robot! Invece ho trovato "+t.getClass()+"!");
	}
	...
	private class FieldView extends JPanel  {
		...
		public void paintComponent(Graphics g) {
			if(fieldImage!=null) g.drawImage(fieldImage,0,0,null);
		}
