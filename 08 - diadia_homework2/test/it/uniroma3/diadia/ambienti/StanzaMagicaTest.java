...
import it.uniroma3.diaida.ambienti.StanzaMagica;
import it.uniroma3.diaida.attrezzi.Attrezzo;

public class StanzaMagicaTest {

	StanzaMagica stanza_magica;
	Attrezzo attrezzo;
	
	@Before
	public void setUp() {
		this.stanza_magica = new StanzaMagica("Stanza Magica",2);
	...
	public void testAddAttrezzoDoppiettaAfterSoglia() {
		stanza_magica.addAttrezzo(new Attrezzo("Colomba",4));
		stanza_magica.addAttrezzo(attrezzo);
		this.attrezzo = stanza_magica.removeAttrezzo(attrezzo);
		stanza_magica.addAttrezzo(attrezzo);
