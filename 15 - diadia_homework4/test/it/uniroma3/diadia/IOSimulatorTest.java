...
public class IOSimulatorTest {
	...
	private String aiuto = "Comandi disponibili:[aiuto][fine][guarda][interagisci][posa][prendi][regala][saluta][vai]\n";
	...
	public void testAiutoComandoNonValidoVaiAccasoFine() {
		...
		this.console.setInput(input);
		this.diadia.gioca();
		assertEquals(benvenuto+aiuto+sconosciuto+dimmiDove+noDirezione+cosaPosi+fine,this.console.getOutput());
	}
