...
public class DiaDiaSimulator {
	...
	public DiaDiaSimulator(IOSimulator console) {	
		this.partita = new Partita(new Labirinto().crea("classico"));
		this.console = console;
	}
	
	public DiaDiaSimulator(Labirinto labiritnto,IOSimulator console) {	
	...
	public void gioca() { 
		...
		while(!processaIstruzione(istruzione)&&this.console.hasNext());
	}   
